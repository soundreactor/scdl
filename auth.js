...
chrome.extension.getBackgroundPage().startAuthHijack=function() {
  ...
  chrome.webRequest.onBeforeSendHeaders.addListener(
    function(details) {
      ...
      if(!hasAUTH){
        details.requestHeaders.push({"name":"Authorization","value":chrome.extension.getBackgroundPage().scdl_oauth});
      }
  ...
  chrome.webRequest.onHeadersReceived.addListener(
    function(details) {
      ...
      details.responseHeaders.push({"name":"Access-Control-Allow-Headers","value":"Authorization, Content-Type, Device-Locale, X-CSRF-Token"});
      details.responseHeaders.push({"name":"Access-Control-Allow-Methods","value":"GET, POST, PUT, PATCH, DELETE"});
      details.responseHeaders.push({"name":"Access-Control-Expose-Headers","value":"Date"});
